class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update) { |u| u.permit(:email, :first_name, :last_name, :bio, :website, :yrs_experience, :zip, :wttravel, :password, :password_confirmation, :current_password) }
  end
end
